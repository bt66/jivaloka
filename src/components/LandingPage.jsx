...
function LandingPage() {
  return (
    <div className="flex flex-col w-[100vw] h-auto min-h-[100vh]">
      ...
      <div className="flex flex-col items-center justify-center lg:py-[8rem] xs:py-[5rem] lg:gap-[3rem] xs:gap-[1rem] w-full h-full">
        ...
        <div className="flex lg:flex-row xs:flex-wrap w-full h-full items-center justify-center lg:gap-5 xs:gap-2 ">
          ...
          <img src={ue1} className="lg:w-[20rem] xs:w-[6.5rem] md:w-[10rem]" />
